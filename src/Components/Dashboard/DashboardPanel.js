    ...
    return (
        <div>
            <div className='md:w-auto w-80 text-center flex flex-col justify-between mb-10 p-10 space-y-2 items-center rounded-md border-solid border-2 border-inherit'>
                ...
                <Link to="/basic-info" className='font-medium hover:cursor-pointer hover:font-bold rounded-[30px] bg-[#F5167E] font-light text-[#fff] px-10 py-2 text-[16px]'>Create</Link>
            </div>
